...
function Login() {
  ...
  const register = () => {
    ...
    axios
      .post("http://localhost:9000/api/user/registration", data)
      .then((respone) => {
        ...
        <motion.div layout className="login-container">
          {selectedView === 0 && (
            ...
            >
              ...
              <span style={{ fontSize: "0.85rem", marginTop: "1rem" }}>
                Nincs még fiókod?{" "}
                <span
                  onClick={() => setSelectedView(1)}
                  style={{ color: "#328cb6", cursor: "pointer" }}
                >
                  Regisztrálok
                </span>
                !
          ...
          {selectedView === 1 && (
            ...
            >
              <AnimatePresence>
                ...
                <span style={{ fontSize: "0.85rem", marginTop: "0.8rem" }}>
                  Van már fiókod?{" "}
                  <span
